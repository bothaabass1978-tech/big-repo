...
(function (BF) {
  ...
  BF.pages.register('creatorpage', {
    ...
    render(params) {
      ...
      return '<div class="creator-hero"><span class="ch-mark">' + BF.icon('anvil', 34) + '</span><div><div class="eyebrow">Creator</div><h1 class="page-title">' + esc(name) + '</h1><div class="ch-stats"><span><b class="num">' + games.length + '</b> games</span><span><b class="num">' + items.length + '</b> avatar items</span><span><b class="num">' + U.compact(visits) + '</b> visits</span><span><b class="num">' + U.fmt(playing) + '</b> playing now</span></div></div></div>' +
